...
> Finds a directory by provided name. If it doesn't find one, it will create the directory in the script's running location and move into the new directory.
  > Create a file with the provided name in the newly corrected directory. It will not allow no name, it must receive input.
